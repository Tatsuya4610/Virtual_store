...
import 'package:virtual_store_flutter/screen/orders/components/order_tile.dart';
    ...
    return Scaffold(
      ...
      body: Consumer<OrdersManager>(builder: (_,ordersManager,__){
        ...
        if (ordersManager.orders.isEmpty) {
          return EmptyCard(title: '注文履歴がありません',iconData: Icons.border_clear,);
        }
        return ListView.builder(itemCount: ordersManager.orders.length, itemBuilder: (__,index) {
          return OrderTile(ordersManager.orders.reversed.toList()[index]);//reversed.toList()逆順番
        });
      },),
    );
  }
